...
[![Build Status](https://img.shields.io/github/actions/workflow/status/brpaz/copier-go/ci.yml?branch=main&style=for-the-badge)](https://github.com/brpaz/copier-go/actions)
...
```bash
copier copy gh:brpaz/copier-go /path/to/your/new/project
```
